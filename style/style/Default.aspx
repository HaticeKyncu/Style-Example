<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="style.Default" %>
                    ...
                    <div class="ct" id="t4">
                        <section>
                            <ul>
                                ...
                                <a href="#t3">
                                    <li class="icon fa fa-pencil " id="tres"></li>
                                </a>
                                <a href="#t4">
                            ...
                            <div class="page" id="p1">
                                <li class="icon fa fa-home"><span class="title">Anasayfa</span><span class="hint"><a href="#" />Anasayfa
                                </span></li>
                            </div>
                            <div class="page" id="p2">
                                <li class="icon fa fa-keyboard-o"><span class="title">İnsan Kaynakları</span></li>
                            </div>
                            <div class="page" id="p3">
                                <li class="icon fa fa-pencil fa-fw"><span class="title">Uygulamalar</span></li>
                            </div>
                            <div class="page" id="p4">
                                <li class="icon fa fa-dribbble"><span class="title">Raporlar</span></li>
                            </div>
